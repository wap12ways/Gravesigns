...
export const DEATH_DELINEATIONS: DelineationEntry[] = [
  ...
  // ── The Ascendant by sign — the horizon at the moment of crossing, the "face"
  //    the passage wore and the sign upon the body (1st house). ───────────────
  {
    key: "asc:Aries",
    family: "asc",
    title: "Aries rising at the crossing",
    body: "Aries stood on the horizon as the soul crossed — a bold, direct face upon the passage. The tradition reads the Ascendant as the outward form a moment takes, and Mars's cardinal fire lends this crossing a quality of forwardness and courage: a threshold met head-on, without hesitation at the gate.",
    source: "Ptolemy, Tetrabiblos III (the horoscopos); Lilly CA on the Ascendant",
    applies: "moment",
  },
  {
    key: "asc:Taurus",
    family: "asc",
    title: "Taurus rising at the crossing",
    body: "Taurus stood on the horizon as the soul crossed — a steady, earthen face upon the passage. Venus's fixed earth lends the crossing patience and a settled composure: a threshold met slowly and fully, the body released only when the holding was truly done.",
    source: "Ptolemy, Tetrabiblos III (the horoscopos); Lilly CA on the Ascendant",
    applies: "moment",
  },
  {
    key: "asc:Gemini",
    family: "asc",
    title: "Gemini rising at the crossing",
    body: "Gemini stood on the horizon as the soul crossed — a light, communicative face upon the passage. Mercury's mutable air lends the crossing a quality of exchange and mediation: a threshold crossed as a word passes between tongues, between one breath and the next.",
    source: "Ptolemy, Tetrabiblos III (the horoscopos); Lilly CA on the Ascendant",
    applies: "moment",
  },
  {
    key: "asc:Cancer",
    family: "asc",
    title: "Cancer rising at the crossing",
    body: "Cancer stood on the horizon as the soul crossed — a tender, sheltering face upon the passage. The Moon's cardinal water lends the crossing intimacy and care: a threshold met close to home and feeling, the passage cradled rather than exposed.",
    source: "Ptolemy, Tetrabiblos III (the horoscopos); Lilly CA on the Ascendant",
    applies: "moment",
  },
  {
    key: "asc:Leo",
    family: "asc",
    title: "Leo rising at the crossing",
    body: "Leo stood on the horizon as the soul crossed — a warm, sovereign face upon the passage. The Sun's fixed fire lends the crossing radiance and dignity: a threshold met with a certain nobility, the soul taking its leave in its own light rather than slipping away unseen.",
    source: "Ptolemy, Tetrabiblos III (the horoscopos); Lilly CA on the Ascendant",
    applies: "moment",
  },
  {
    key: "asc:Virgo",
    family: "asc",
    title: "Virgo rising at the crossing",
    body: "Virgo stood on the horizon as the soul crossed — a careful, exact face upon the passage. Mercury's mutable earth lends the crossing quietness and precision: a threshold met the way a task is finished and set down, the hands finally still.",
    source: "Ptolemy, Tetrabiblos III (the horoscopos); Lilly CA on the Ascendant",
    applies: "moment",
  },
  {
    key: "asc:Libra",
    family: "asc",
    title: "Libra rising at the crossing",
    body: "Libra stood on the horizon as the soul crossed — a graceful, balancing face upon the passage. Venus's cardinal air lends the crossing harmony and relation: a threshold met in the softening of day into evening, the scales quietly coming level at the last.",
    source: "Ptolemy, Tetrabiblos III (the horoscopos); Lilly CA on the Ascendant",
    applies: "moment",
  },
  {
    key: "asc:Scorpio",
    family: "asc",
    title: "Scorpio rising at the crossing",
    body: "Scorpio stood on the horizon as the soul crossed — a deep, unflinching face upon the passage. Mars's fixed water lends the crossing intensity and intimacy with the depths: a threshold met by the profound rather than the shallow, a passage through rather than around.",
    source: "Ptolemy, Tetrabiblos III (the horoscopos); Lilly CA on the Ascendant",
    applies: "moment",
  },
  {
    key: "asc:Sagittarius",
    family: "asc",
    title: "Sagittarius rising at the crossing",
    body: "Sagittarius stood on the horizon as the soul crossed — an open, far-seeing face upon the passage. Jupiter's mutable fire lends the crossing breadth and faith: a threshold met as a traveller crosses a longed-for border, the soul widening past the gate rather than shrinking at it.",
    source: "Ptolemy, Tetrabiblos III (the horoscopos); Lilly CA on the Ascendant",
    applies: "moment",
  },
  {
    key: "asc:Capricorn",
    family: "asc",
    title: "Capricorn rising at the crossing",
    body: "Capricorn stood on the horizon as the soul crossed — a grave, enduring face upon the passage. Saturn's cardinal earth lends the crossing composure and gravity: a threshold met like a summit reached after a long climb, the weight of the life set down with dignity.",
    source: "Ptolemy, Tetrabiblos III (the horoscopos); Lilly CA on the Ascendant",
    applies: "moment",
  },
  {
    key: "asc:Aquarius",
    family: "asc",
    title: "Aquarius rising at the crossing",
    body: "Aquarius stood on the horizon as the soul crossed — a cool, wide-belonging face upon the passage. Saturn's fixed air lends the crossing clarity and a sense of the collective: a threshold met as a return to a whole the soul never truly left, impersonal and at peace.",
    source: "Ptolemy, Tetrabiblos III (the horoscopos); Lilly CA on the Ascendant",
    applies: "moment",
  },
  {
    key: "asc:Pisces",
    family: "asc",
    title: "Pisces rising at the crossing",
    body: "Pisces stood on the horizon as the soul crossed — a porous, merciful face upon the passage. Jupiter's mutable water lends the crossing surrender and compassion: a threshold met like tide meeting tide, the boundary between the soul and what receives it already thin, and at the last simply giving way.",
    source: "Ptolemy, Tetrabiblos III (the horoscopos); Lilly CA on the Ascendant",
    applies: "moment",
  },

  // ── The lord of the 8th by house — where the ruler of death's own house is
  //    carried, and so where the matter of the crossing is seated. ────────────
  {
    key: "lord8:1",
    family: "lord8",
    title: "The lord of the 8th in the 1st house",
    body: "The ruler of the house of death is carried into the 1st — the house of the self and the body. The tradition reads the 8th's lord in the 1st as the matter of the crossing seated in the person themselves: the passage bound up with the body and the very identity of the one who crossed, close and personal rather than distant.",
    source: "Lilly CA p.653 (the lord of the 8th and its house); traditional doctrine",
    applies: "moment",
  },
  {
    key: "lord8:2",
    family: "lord8",
    title: "The lord of the 8th in the 2nd house",
    body: "The ruler of the house of death is carried into the 2nd — the house of substance and what is held. The tradition reads this as the matter of the crossing bound up with what the soul possessed and valued, what was gathered in life and now released from the hands.",
    source: "Lilly CA (the lord of the 8th and its house); traditional doctrine",
    applies: "moment",
  },
  {
    key: "lord8:3",
    family: "lord8",
    title: "The lord of the 8th in the 3rd house",
    body: "The ruler of the house of death is carried into the 3rd — the house of kin, the near, and the everyday mind. The tradition reads this as the matter of the crossing woven among siblings and neighbours, the immediate world and its ordinary comings and goings.",
    source: "Lilly CA (the lord of the 8th and its house); traditional doctrine",
    applies: "moment",
  },
  {
    key: "lord8:4",
    family: "lord8",
    title: "The lord of the 8th in the 4th house",
    body: "The ruler of the house of death is carried into the 4th — the foundation, the roots, the end of the matter. The tradition reads this as an especially fitting seat: the matter of the crossing come home to the deepest place of the chart, the passage bound up with rest, ancestry, and final belonging.",
    source: "Lilly CA (the lord of the 8th and its house; the 4th as terminus)",
    applies: "moment",
  },
  {
    key: "lord8:5",
    family: "lord8",
    title: "The lord of the 8th in the 5th house",
    body: "The ruler of the house of death is carried into the 5th — the house of children, joy, and what the soul made. The tradition reads this as the matter of the crossing touching creation and delight, the passage bound up with what was loved and brought forth in life.",
    source: "Lilly CA (the lord of the 8th and its house); traditional doctrine",
    applies: "moment",
  },
  {
    key: "lord8:6",
    family: "lord8",
    title: "The lord of the 8th in the 6th house",
    body: "The ruler of the house of death is carried into the 6th — the house of service, labour, and the frailties of the body. The tradition reads this as the matter of the crossing seated in the daily work and the wearing of the vessel; read it gently, as the ordinary faithfulness of a life, never as a named affliction.",
    source: "Lilly CA (the lord of the 8th and its house); traditional doctrine",
    applies: "moment",
  },
  {
    key: "lord8:7",
    family: "lord8",
    title: "The lord of the 8th in the 7th house",
    body: "The ruler of the house of death is carried into the 7th — the house of the other, partnership and the beloved. The tradition reads this as the matter of the crossing bound up with relationship: the passage held in the company of those the soul was joined to, witnessed across the table of another.",
    source: "Lilly CA (the lord of the 8th and its house); traditional doctrine",
    applies: "moment",
  },
  {
    key: "lord8:8",
    family: "lord8",
    title: "The lord of the 8th in the 8th house",
    body: "The ruler of the house of death sits in its own house — the 8th, doubled and at home. The tradition reads this as the matter of the crossing wholly self-possessed: the theme of ending native and undivided, the gate kept by its own lord with nothing borrowed or displaced.",
    source: "Lilly CA (the lord of the 8th in its own house); traditional doctrine",
    applies: "moment",
  },
  {
    key: "lord8:9",
    family: "lord8",
    title: "The lord of the 8th in the 9th house",
    body: "The ruler of the house of death is carried into the 9th — the house of faith, philosophy, and the far journey. The tradition reads this as the matter of the crossing lifted toward meaning: the passage bound up with belief and the long view, the soul's ending touched by the sense of a greater journey.",
    source: "Lilly CA (the lord of the 8th and its house); traditional doctrine",
    applies: "moment",
  },
  {
    key: "lord8:10",
    family: "lord8",
    title: "The lord of the 8th in the 10th house",
    body: "The ruler of the house of death is carried into the 10th — the house of vocation, standing, and what is seen. The tradition reads this as the matter of the crossing raised into the public and the enduring: the passage bound up with the soul's work and the mark it made in the world.",
    source: "Lilly CA (the lord of the 8th and its house); traditional doctrine",
    applies: "moment",
  },
  {
    key: "lord8:11",
    family: "lord8",
    title: "The lord of the 8th in the 11th house",
    body: "The ruler of the house of death is carried into the 11th — the house of friends, community, and hopes. The tradition reads this as the matter of the crossing held among companions: the passage bound up with the wider circle that loved the soul, and with the hopes it carried for those it leaves.",
    source: "Lilly CA (the lord of the 8th and its house); traditional doctrine",
    applies: "moment",
  },
  {
    key: "lord8:12",
    family: "lord8",
    title: "The lord of the 8th in the 12th house",
    body: "The ruler of the house of death is carried into the 12th — the house of the hidden, sorrow, and what is undone. The tradition reads this as the matter of the crossing withdrawn into the unseen: the passage approached through solitude and mystery, the soul drawing quietly inward before the gate.",
    source: "Lilly CA (the lord of the 8th and its house; the 12th of the hidden)",
    applies: "moment",
  },
];
