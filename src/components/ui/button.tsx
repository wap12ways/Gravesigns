...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-b from-gold-light to-gold-deep text-primary-foreground shadow-[0_0_25px_-6px_rgba(233,196,106,0.6)] hover:shadow-[0_0_35px_-4px_rgba(233,196,106,0.8)] hover:brightness-105",
        outline:
          "border border-gold/40 text-gold-light hover:bg-gold/10 hover:border-gold/70",
        ghost: "text-foreground/80 hover:text-gold-light hover:bg-white/5",
        secondary:
